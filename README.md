...
With this in mind, with coronavirus affecting primary dates and voting across the country, we've explored possible ways to keep voting turnout in older adults similar to pre-coronavirus levels. Although there isn't a clear solution to this issue, mail-in-voting with increased voter engagement (which can certainly be affected by fraudulent or corrupt politicians), can be a potential solution in poorer, less-educated counties like Allegany and Garrett. While traditional voting requires time, transportation, and a whole slew of barriers to vote in person (for the elderly: mobility issues, disability, etc.), mail-in-voting is still somewhat difficult for elderly populations, but does not require as many resources to vote. Furthermore, politicians can engage 65 and up voters by means of mail, encouraging them through flyers, ads, etc. to ensure that 65 and up voices will be heard and counted for. It is up to the politicians to make the 65 and up group feel valued and inspired to vote, particularly in counties like Allegany and Garrett, which may see even lower voter turnout this year due to coronavirus.

## Future Suggestions

In light of the recent COVID-19 pandemic, politicians and leaders can try to increase the popularity of absentee voting, which is historically an unpopular voting method in Maryland. Yes, there are many obstacles to absentee voting as well, including your vote getting "lost," and that some Americans, particularly the elderly, feel "pride" in voting at a polling location. However, because it is particularly unsafe for those over 65 to be vote in-person, particular importance needs to be placed to ensure that they voting rights are maintained.  

Traditional voting methods have become far too corrupt and serve to block off minority and low income voters. Coronavirus will likely disproportionally disenfranchise low income citizens, especially in the 65 and up age group, because they will choose not to vote in fear of getting infected. Knowing how to target different counties based on their demographics will be essential to maintaining high voter turnout in the 2020 general election following a global pandemic. Civic engagement needs to be especially encouraged in counties like Allegany, where citizens are generally low income with low educational attainment and where voter turnout has been historically low (53% in 2016). Richer counties like Howard or Montgomery, on the other hand, might benefit more from standard voting campaigns since they are typically better educated and more likely to vote (68% and 62% voter turnout in 2016, respectively).

In light of the coronavirus pandemic, voting methods need to change. Hopefully within the next few months, we will see a push for mail-in/absentee voting for the general election. It would be interesting to start a community-driven grassroots campaign to encourage suppressed voices (like low income elderly) to vote through absentee ballots. Because counties like Talbot, Queen Anne's, and Baltimore County face the highest risk of coronavirus infections, there must be special emphasis placed in these counties. Now is the time to aid the elderly, by encouraging them to stay home, providing financial relief, and through other means. 
